...
After removing the outliers density plots are plotted to check the distribution of data and identifying whether the variables follow a normal distribution or are skewed and the skewed variables are log transformed fro regression. 
...
##### Inference : No log transformation required since the skeweness is not as extreme as the other variables.
