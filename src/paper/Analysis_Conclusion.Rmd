...
knitr::opts_chunk$set( include=FALSE,echo = FALSE, warning = FALSE, message= FALSE,fig.width = 8,fig.height = 6,fig.align = 'center',dpi=300,dev='png',fig.retina = 2,fig.cap = NULL)
```
...
combined_model <- ("../../gen/output/combined_model.rds")
```
...
```{r residuals plot model 1,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE,fig.cap=""}
plot(model1, which = 1)
```
...
```{r qqplot model 1,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE,fig.cap=""}
plot(model1, which = 2)
...
```{r scale-loc plot model 1,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE,fig.cap=""}
plot(model1, which = 3)
```
...
```{r residual leverage model 1,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE,fig.cap=""}
plot(model1, which = 5)
```
...
```{r residuals plot model 2,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE,fig.cap=""}
...
```{r summary-model1,warning=FALSE,echo=TRUE,message=FALSE}
...
```{r summary-model2,warning=FALSE,echo=TRUE,message=FALSE}
summary(model2)
```
...
```{r summary-combined model,warning=FALSE,echo=TRUE,message=FALSE}
