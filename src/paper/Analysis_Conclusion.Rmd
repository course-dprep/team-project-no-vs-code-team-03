...
```{r residuals plot model 1,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model1, which = 1)
```
...
```{r qqplot model 1,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model1, which = 2)
...
```{r scale-loc plot model 1,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model1, which = 3)
```
...
```{r residual leverage model 1,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model1, which = 5)
```
...
```{r residuals plot model 2,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
...
```{r qqplot model 2,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model2, which = 2)
...
```{r scale-loc plot 2,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model2, which = 3)
```
...
```{r leverage 2,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model2, which = 5)
