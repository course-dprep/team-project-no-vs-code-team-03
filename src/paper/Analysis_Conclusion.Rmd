...
```{r residuals plot,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model1, which = 1)
```
...
```{r qqplot,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model1, which = 2)
...
```{r scale-loc plot,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model1, which = 3)
```
...
```{r residual leverage,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model1, which = 5)
```
...
```{r leverage,include=TRUE,warning=FALSE,echo=FALSE,message=FALSE}
plot(model2, which = 5)
