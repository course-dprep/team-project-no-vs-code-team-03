...
```{r series-length-vs-rating-episodes, echo=FALSE, warning=FALSE, message=FALSE,fig.cap="",fig.width=10,fig.height=6, dpi=400}
# Scatter plot for count of episodes vs average rating (cleaned data)
library(ggplot2)

ggplot(cleaned_data, aes(x = episode_count, y = averageRating)) +
  geom_jitter(alpha = 0.8, size = 2, width = 0.1, height = 0.1, color ="skyblue") +  
...
```{r total-years-vs-rating, echo=FALSE, warning=FALSE, message=FALSE,fig.cap="",fig.width=10,fig.height=6,dpi=400}
...
ggplot(cleaned_data, aes(x = total_years, y = averageRating)) +
  geom_jitter(alpha = 0.9, size = 2.5, width = 0.05, height = 0.05, color = "darkgreen") +  
