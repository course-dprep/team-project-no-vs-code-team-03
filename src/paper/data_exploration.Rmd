...
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message= FALSE,fig.width = 8,fig.height = 6,fig.align = 'center',dpi=300,dev='png',fig.retina = 2)
```
...
```{r ratings distribution raw data,echo=FALSE,warning=FALSE, message=FALSE,fig.cap=NULL}
...
```{r series-length-vs-rating-episodes, echo=FALSE, warning=FALSE, message=FALSE,fig.cap=NULL}
# Scatter plot for count of episodes vs average rating (cleaned data)
library(ggplot2)

ggplot(cleaned_data, aes(x = episode_count, y = averageRating)) +
  geom_jitter(alpha = 0.3, size = 0.8, width = 0.3, height = 0, color ="deepskyblue") +  
...
```{r total-years-vs-rating, echo=FALSE, warning=FALSE, message=FALSE,fig.cap=NULL}
...
ggplot(cleaned_data, aes(x = total_years, y = averageRating)) +
  geom_jitter(alpha = 0.3, size = 0.8, width = 0.3, height = 0, color = "darkgreen") +  
...
```{r heatmap,echo=FALSE,warning=FALSE, message=FALSE,fig.cap=NULL}
...
```{r density plot total_years, echo=FALSE,warning=FALSE, message=FALSE,fig.cap=NULL}
...
```{r density plot episode_count,echo=FALSE,warning=FALSE, message=FALSE,fig.cap=NULL}
...
```{r density plot averageRating, echo=FALSE,warning=FALSE, message=FALSE,fig.cap=NULL}
...
```{r density plot numVotes,echo=FALSE,warning=FALSE, message=FALSE,fig.cap=NULL}
